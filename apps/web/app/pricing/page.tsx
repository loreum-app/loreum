...
const tiers = [
  {
    ...
    period: "forever",
    description:
      "Full worldbuilding platform with AI integration. Bring your own AI.",
    ...
    features: [
      ...
      "Connect Claude, Cursor, and other AI apps with OAuth",
...
const comparison: ComparisonRow[] = [
  ...
  {
    feature: "Style guide + character voices",
    free: true,
    pro: true,
    team: true,
  },
  ...
  {
    feature: "Collaborator suggestion mode",
    free: false,
    pro: false,
    team: true,
  },
