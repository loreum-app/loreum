...
import type { CreateEntityRequest } from "@loreum/types";
...
export class CreateEntityDto implements CreateEntityRequest {
  @ApiProperty({ enum: ENTITY_TYPES, example: "CHARACTER" })
  @IsEnum(ENTITY_TYPES)
